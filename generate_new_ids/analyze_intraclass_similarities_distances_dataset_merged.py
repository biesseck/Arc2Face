...
if __name__ == "__main__":
    ...
    parser.add_argument('--input-path', type=str, default='/nobackup3/bjgbiesseck/CASIA-Webface/imgs_crops_112x112_FACE_EMBEDDINGS_R100_WebFace42M_ArcFace')
    parser.add_argument('--subjs-list-path', type=str, default='/nobackup3/bjgbiesseck/CASIA-Webface/merge_with_dataset_glint360k-glint360k-imgs_FACE_EMBEDDINGS_sim-range=[0.4,0.49]/dict_paths_new_subjs_base_subjs.json')
